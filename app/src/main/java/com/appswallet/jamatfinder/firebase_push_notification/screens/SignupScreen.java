...
public class SignupScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAuthFbIntance();   //Get Firebase auth instance
        initViews();
        viewsListners();
    }

    private void getAuthFbIntance() {
    ...
    private void viewsListners() {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //create user
                auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(SignupScreen.this,
                                                                                           new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(SignupScreen.this, "createUserWithEmail:onComplete:" + task.isSuccessful(),
